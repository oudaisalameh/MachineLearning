...
Original file is located at
    https://colab.research.google.com/drive/1LEdaO-SFn9TzaUki75wgPG1RpWMoOAzV
"""
...
class AlexNet(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # the dimensions after the first convolution layer do not lead to 55 x 55.
...
if __name__ == '__main__':
    ...
    train_dataset = datasets.ImageNet(INPUT_ROOT_DIR, split='train', transform=transforms.Compose([
        ...
        for imgs, classes in dataloader:
            ...
            if total_steps % 10 == 0:
                with torch.no_grad():
                    ...
                    print('Epoch: {} \tStep: {} \tLoss: {:.4f} \tAcc: {}'.format(
